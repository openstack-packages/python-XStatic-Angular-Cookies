...
%global pypi_name XStatic-Angular-Cookies

Name:           python-%{pypi_name}
Version:        XXX
Release:        1%{?dist}
Summary:        Angular-Cookies JavaScript library packaged for setuptools

License:        MIT
URL:            http://git.openstack.org/cgit/stackforge/xstatic-angular-cookies/
...
%description
Angular-Cookies javascript library packaged for
...
%files
%doc README.txt
%{python_sitelib}/XStatic_Angular_Cookies-%{version}-py?.?.egg-info
%{python_sitelib}/XStatic_Angular_Cookies-%{version}-py?.?-nspkg.pth
%{python_sitelib}/xstatic/pkg/angular_cookies
